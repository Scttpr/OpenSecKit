...
- `risks.md` par feature (brouillon)
- `risk-register.yaml` (consolidé)
...
> Utilisez `/osk-dashboard` pour suivre la conformité, `/osk-rgpd audit` ou `/osk-rgs renew` pour les audits par domaine.
