...
- [_example-ecommerce-risk.md](_example-ecommerce-risk.md) - Analyse de risques complète pour une application e-commerce
...
Vous avez des améliorations pour les modèles d'analyse de risques ? Voir les [directives de contribution](../../.github/CONTRIBUTING.md).
