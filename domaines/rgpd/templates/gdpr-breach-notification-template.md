...
| **Allemagne** | BfDI (Bundesbeauftragter für den Datenschutz und die Informationsfreiheit) | https://www.bfdi.bund.de/DE/Datenschutz/Meldung/Meldung_node.html | poststelle@bfdi.bund.de | +49 228 997799-0 |
| **Irlande** | DPC (Data Protection Commission) | https://forms.dataprotection.ie/contact | info@dataprotection.ie | +353 761 104 800 |
| **Pays-Bas** | AP (Autoriteit Persoonsgegevens) | https://www.autoriteitpersoonsgegevens.nl/nl/zelf-doen/meld-een-datalek | info@autoriteitpersoonsgegevens.nl | +31 70 888 8500 |
| **Espagne** | AEPD (Agencia Española de Protección de Datos) | https://www.aepd.es/es/derechos-y-deberes/cumple-tus-deberes/medidas-de-cumplimiento/brechas-de-datos | consultasprotecciondatos@aepd.es | +34 901 100 099 |
...
- **Portail en ligne** : [ex : "CNIL : https://notifications.cnil.fr/"] ← **Préféré**
...
Pour toute question ou contribution, voir [Directives de contribution](../../../.github/CONTRIBUTING.md).