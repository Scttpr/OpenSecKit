...
This command lists all compliance frameworks available in OpenSecKit by scanning the `phases/comply/frameworks/` directory for `framework.yaml` files.

# Process

## Phase 1: Scan for Frameworks

Scan `phases/comply/frameworks/*/framework.yaml` for all framework definitions:

```bash
# Pattern: phases/comply/frameworks/<framework-id>/framework.yaml
# Example: phases/comply/frameworks/rgpd/framework.yaml
```

Skip:
- `phases/comply/frameworks/_schema/` (schema directory)
- `phases/comply/frameworks/_template/` (template directory)
...
1. **Dynamic Discovery**: Scan `phases/comply/frameworks/` directory, don't hardcode frameworks
