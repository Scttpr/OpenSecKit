...
- `phases/comply/frameworks/rgs/framework.yaml` → RGS controls and requirements
- `phases/comply/frameworks/rgs/knowledge/` → Regulatory knowledge base (ANSSI, EBIOS RM)
- `phases/comply/frameworks/rgs/schemas/assessment-extension.yaml` → RGS-specific assessment fields
- `phases/comply/frameworks/rgs/schemas/tool-certifications.yaml` → Tool certification requirements by RGS level
- `phases/comply/frameworks/_shared/eidas-levels.yaml` → eIDAS trust level mapping
...
- `phases/comply/frameworks/rgs/templates/assessment-summary.md.tera` → summary report
- `phases/comply/frameworks/rgs/templates/homologation-checklist.md.tera` → certification checklist
- `phases/comply/frameworks/rgs/templates/system-perimeter.md.tera` → perimeter definition

**Reference Documentation:**
- `phases/comply/frameworks/rgs/WORKFLOW-AND-SCORING.md` → Scoring algorithm and DICP calculation
- `phases/comply/frameworks/rgs/CRYPTO-REFERENCE.md` → ANSSI-approved cryptographic algorithms
- `phases/comply/frameworks/rgs/SYSTEM-MODEL-REQUIREMENTS.md` → Required system model data by control

**Schema (template data contract):**
- `phases/comply/frameworks/_schema/assessment.yaml` → Base assessment output schema
- `phases/comply/frameworks/rgs/schemas/assessment-extension.yaml` → RGS-specific fields

# Knowledge Base Usage

Consult the knowledge base (`phases/comply/frameworks/rgs/knowledge/`) during assessment:
...
- `phases/comply/frameworks/rgs/templates/assessment-summary.md.tera`
- `phases/comply/frameworks/rgs/templates/homologation-checklist.md.tera`
- `phases/comply/frameworks/rgs/templates/system-perimeter.md.tera`
...
Use template: `phases/comply/frameworks/rgs/templates/export-dossier.md.tera`
